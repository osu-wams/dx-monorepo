      ...
      <Menu>
        ...
        <ProfileMenuList>
          <MenuLink
            ...
            onSelect={() => Event('header', 'user-button-menu', 'Profile link from User Button dropdown')}
          >
          ...
          <MenuLink as="a" href="/logout" onSelect={() => Event('header', 'user-button-menu', 'Logout link clicked')}>
